...
exports.createPurchaseOrderValidationRules = [
    ...
    body('ShippingAddress.AddressLine2').optional().optional().withMessage('Shipping Address Line 2 must be a string'),
    body('ShippingAddress.City').optional().notEmpty().withMessage('Shipping Address City is required'),
    body('ShippingAddress.StateProvince').optional().optional().withMessage('Shipping Address State/Province must be a string'),
    ...
    body('BillingAddress.AddressLine2').optional().optional().withMessage('Billing Address Line 2 must be a string'),
    body('BillingAddress.City').optional().notEmpty().withMessage('Billing Address City is required'),
    body('BillingAddress.StateProvince').optional().optional().withMessage('Billing Address State/Province must be a string'),
